...
function Header()
{
    ...
    $this->Cell(30,10,'TOKO KITA');

    $this->Ln(10);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Jl STMIK AKAKOM');

    $this->cell(80);
    $this->SetFont('Arial','',10);
    $this->cell(30,10,'Yogyakarta, '.base64_decode($_GET['uuid']).'');
    $this->Line(10,40,200,40);

    $this->Ln(5);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Telp/Fax : 08123456789');
    $this->Line(10,40,200,40);
...
function BasicTable($header, $data)
{
    ...
    $this->cell(30,-10,'* Barang Yang Sudah Dibeli Tidak Bisa Dikembalikan atau Ditukar.');
}
}
...
$pdf->Output('','TOKO KITA/'.$filename.'.pdf');
?>
