		...
		<div class="bgwhite">
			<div class="padding">
				...
				<form class="form-input" method="post" action="handler.php?action=tambah_barang">
					<input type="text" name="nama_barang" placeholder="Nama Barang" required="required" min=0>
					<input type="number" name="stok" placeholder="Stok" required="required" min=0>
					<input type="number" name="harga_beli" placeholder="Harga Beli" required="required" min=0>
					<input type="number" name="harga_jual" placeholder="Harga Jual" required="required" min=0>
